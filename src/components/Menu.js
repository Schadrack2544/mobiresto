...
function Menu() {
    return (
        <div className="bg-gray-500 min-h-max p-2.5 flex justify-between">
            ...
            <div>
                ...
                <ul className="flex text-white uppercase">
                    ...
                    <li className="p-2.5"><Link to='/foods'>Food</Link></li>
                    <li className="p-2.5"><Link to='/orders'>Orders</Link></li>
                </ul>
           </div>
